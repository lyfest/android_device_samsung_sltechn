...
TARGET_OTA_ASSERT_DEVICE := sltechn,SM-G8508S
...
BOARD_KERNEL_CMDLINE := console=null androidboot.hardware=qcom androidboot.selinux=disabled user_debug=31 msm_rtb.filter=0x37 ehci-hcd.park=3
